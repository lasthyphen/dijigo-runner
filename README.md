...
```sh
git clone https://github.com/lasthyphen/dijigo-runner.git
```
...
1. You have the latest AvalancheGo binaries at `$GOPATH/src/github.com/lasthyphen/dijigo/build`. For instructions on setting up AvalancheGo, see [here.](https://github.com/lasthyphen/dijigo)
2. The network runner direcory is at `$GOPATH/src/github.com/lasthyphen/dijigo-runner`.
...
**What does `network-runner` do?** The primary focus of [`network-runner`](https://github.com/lasthyphen/dijigo-runner) is to create a local network, as a test framework for local development.
...
```bash
# to install
cd ${HOME}/go/src/github.com/lasthyphen/dijigo-runner
...
curl -X POST -k http://localhost:8081/v1/control/start -d '{"execPath":"/Users/gyuho.lee/go/src/github.com/lasthyphen/dijigo/build/avalanchego","whitelistedSubnets":"24tZhrm8j8GCJRE9PomW8FaeqbgGS4UAQjJnqqn8pq5NwYSYV1","logLevel":"INFO"}'

# or
avalanche-network-runner control start \
--log-level debug \
--endpoint="0.0.0.0:8080" \
--avalanchego-path ${HOME}/go/src/github.com/lasthyphen/dijigo/build/avalanchego \
...
# https://github.com/lasthyphen/dijigo/releases
VERSION=1.7.3
GOARCH=$(go env GOARCH)
GOOS=$(go env GOOS)
DOWNLOAD_URL=https://github.com/lasthyphen/dijigo/releases/download/v${VERSION}/avalanchego-linux-${GOARCH}-v${VERSION}.tar.gz
DOWNLOAD_PATH=/tmp/avalanchego.tar.gz
if [[ ${GOOS} == "darwin" ]]; then
  DOWNLOAD_URL=https://github.com/lasthyphen/dijigo/releases/download/v${VERSION}/avalanchego-macos-v${VERSION}.zip
