...
import (
	...
	ids "github.com/lasthyphen/dijigo/ids"
...
// GetVMs provides a mock function with given fields: _a0
func (_m *InfoClient) GetVMs(_a0 context.Context) (map[ids.ID][]string, error) {
	ret := _m.Called(_a0)
...
func (_m *InfoClient) Peers(_a0 context.Context) ([]info.Peer, error) {
	ret := _m.Called(_a0)
